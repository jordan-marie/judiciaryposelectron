...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-1">Create Dynamic Form</h3>
        <p class="text-muted small mb-0">Define form parameters, target user roles, and dynamic input fields</p>
    </div>
...
<form action="{{ route('admin.forms.store') }}" method="POST" id="form-builder-form">
    @csrf
    <div class="row g-4">
            ...
            <div class="card border-0 shadow-sm rounded-3 mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. Scrap Metal Inbound Form" required>
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label fw-bold">Description</label>
                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Brief explanation of this weighment form...">{{ old('description') }}</textarea>
                    </div>
                ...
                <div class="card-body">
                    ...
                    @foreach($roles as $role)
                        <div class="form-check mb-2">
                            <input class="form-check-input role-checkbox" type="checkbox" name="roles[]" value="{{ $role->id }}" id="role_{{ $role->id }}" {{ loop->first ? 'checked' : '' }}>
        ...
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <div class="card-body p-3">
                    ...
                    <div id="no-fields-warning" class="text-center py-4 text-muted border border-dashed rounded-3">
                ...
                <div class="card-footer bg-body py-3 border-top d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary fw-bold px-4">
                        <i class="bi bi-check-circle-fill me-1"></i> Save & Publish Form
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="card border border-secondary border-opacity-25 shadow-sm field-item">
        <div class="card-body p-3">
            ...
            <div class="row g-3">
                ...
                <!-- Select Dropdown Options Container (Hidden by default unless Select type is chosen) -->
...
<script>
    $(document).ready(function() {
        ...
        // Add 2 default sample fields if new form
        addFieldRow('Customer / Supplier Name', 'text', true);
        addFieldRow('Material Category', 'select', true, 'General Waste, Aggregates, Metals, Plastics');
    });
</script>
@endpush
